...
- [x] Producción y su panel — el panel ya existía; sus recuentos de capítulos y escenas
      enlazan a `script/chapters`, y el de jornadas a `rodaje`, cerrado al integrar las dos
      ramas que traían cada destino
