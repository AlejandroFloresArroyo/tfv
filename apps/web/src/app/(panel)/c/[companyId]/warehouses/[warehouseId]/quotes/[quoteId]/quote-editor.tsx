              ...
              <li key={draft.measurementId}>
                <Panel className="p-4">
                  ...
                  {over ? (
                    ...
                    <p className="mt-3 inline-flex items-center gap-1.5 text-body3 text-tinta-cuida">
                      <TriangleAlert className="size-4" aria-hidden="true" />
                      {t("unpriced")}
                    </p>
                  ) : null}
                ...
                >
                  ...
                  */}
                  <span className="w-24 shrink-0 text-right tablet:w-32">
                    ...
                    <span
                      className={`block text-body3 ${rate.fallback ? "text-tinta-cuida" : "text-content-faint"}`}
                    >
                      {rate.fallback
                        ? t("noDailyRate")
                        : type === "rent"
